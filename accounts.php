    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <!-- Sidebar Menu Users - These collapse to the responsive navigation menu on small screens -->
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="losted.php"><span class="glyphicon glyphicon-record" aria-hidden="true"></span> Lost Item</a>
                        </li>
                           <?php
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <button class="btn btn-primary" id="add-new-account">Add New User Acoount
        ...
        <!-- /#wrapper -->
        <?php include_once('modal/add_new_account.php'); ?>
